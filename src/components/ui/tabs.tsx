...
>(({ className, variant, size, state, isModified, closable, onClose, counter, icon, children, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      // Use Fleet CSS variables for states handled by Radix
...
// Specialized Tab Variants based on Fleet Gallery
